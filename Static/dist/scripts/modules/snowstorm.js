(function () {
    if ($('body').hasClass('is-snowing')) {
        ...
        function getRandomUrlImage() {
            ...
            {
                case 0:
                    return 'url("/Static/images/newDesign/cherry-blossom.svg")';
                    break;
                case 1:
                    return 'url("/Static/images/newDesign/sunflower.svg")';
                    break;
            }
        }
